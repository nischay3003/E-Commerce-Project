...
"[project]/pages/auth/login.js [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/users/login', {
                email,
                password
            });
            setError(null);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffe1fd9e._.js.map